...
const Countdown = () => {
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      ...
      const valentinesDay = new Date("2021-06-09T00:00:00");
      const now = new Date();
          ...
          <>
            ...
            <div className="text-center">
              ...
              <p className="text-sakura-600 text-xl font-romantic italic">
                Packing my love for all our tomorrows..
              </p>
            </div>
          </>
        ) : (
